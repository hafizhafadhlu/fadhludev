...
color = cycle(['light blue','light pink','light yellow','light green','red','green','blue','black'])
egg_width = 45
egg_height = 55
egg_score = 10
egg_speed = 500
...
def create_eggs():
    x = randrange(10,740)
    y = 40
    new_egg = c.create_oval(x,y,x+egg_width,y+egg_height , fill=next(color) , width=0)
    eggs.append(new_egg)
